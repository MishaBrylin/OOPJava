...
import Task06.chars.HeroTeam;
import Task06.chars.Vector2;
    ...
    public static void view(){
        if (step++ == 0) {
            ...
            System.out.print(AnsiColors.ANSI_BLUE +
                    String.join("", Collections.nCopies(15, formatDiv(" "))) + "Blue Team" + AnsiColors.ANSI_RESET);
            System.out.println(AnsiColors.ANSI_GREEN +
                    String.join("", Collections.nCopies(70, formatDiv(" "))) + "Green Team" + AnsiColors.ANSI_RESET);
        } else {
