...
public abstract class Base implements IAction {
    ...
    public Base(int attack, int protection, int shoot, int[] damage,
                ...
                boolean magic, String name, String heroName)
    {
        this.attack = attack;
    ...
    public String GetInfo() {
        ...
        String outStr = String.format("Name: %-5s, class: %-2s, \t⚔%-2s,\t\uD83D\uDEE1 %-2s,\t♥%d - %,-3d\t⚡%d-%d,\uD83C\uDFC3 %d\t", heroName, name, attack, protection, (int)maxHealth, (int)currentHealth, damage[0], damage[1], speed);
        return outStr;
    }
